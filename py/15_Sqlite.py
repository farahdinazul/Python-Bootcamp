...
class DatabaseManager:
    ...
    def delete_user(self, user_id):
        """Deletes a user and their posts from the database."""
        with sqlite3.connect(self.db_name) as conn:
            cursor = conn.cursor()
    ...
    #Run on Terminal Function to test the DatabaseManager class
def display_menu():
    """Displays a simple menu for interacting with the database."""
    print("\n" + "+"*40)
