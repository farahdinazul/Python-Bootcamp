...
mongo_uri=os.getenv("MONGODB_ATLAS_CLUSTER_URI") #Get the MongoDB URI from environment variables
...
class DatabaseManager:
    ...
    def init_database(self):
        ...
        #Create unique index on user_id for posts for better query performance
...
def main():
    ...
    try:
        ...
        print("Make sure MongoDB is running on localhost:27017 or check your connection string.")
        return
